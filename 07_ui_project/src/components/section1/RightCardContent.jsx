...
const RightCardContent = () => {
  return (
    <div className="h-full w-full absolute top-0 left-0  p-8 flex flex-col justify-between">
            ...
            <div>
                <p className="text-xl text-white leading-relaxed mb-14">Prime customers, that have access to bank credit and satisfied with current product</p>
                <div className="flex justify-between">
                <button className="bg-blue-600 text-white font-semibold px-8 py-2 rounded-full">Satisfied</button>
