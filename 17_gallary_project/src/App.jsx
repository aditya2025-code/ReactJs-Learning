...
const App = () => {
  ...
  return (
    <div className='bg-black overflow-auto h-screen p-4 text-white'>
      <h1 className='flex justify-center font-bold text-2xl'>API Calling Galary</h1>
      <div className='h-[82%] flex flex-wrap gap-4 p-4'>
        {printUserData}
      </div>
      <div
        className='flex justify-center item-center p-4 gap-6'>
        <button
